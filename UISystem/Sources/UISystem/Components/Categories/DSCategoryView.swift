...
#Preview {
  DSCategoryView(
    title: "Любимое из детства",
    url: URL(string: "https://damcdn.samokat.ru/dam-storage-ext-env-prod/2025/10/bcb87384-87c0-45a3-b4a7-cf66768437e4"),
    action: { print("Category clicked") }
  )
}
