...
actor MockCatalogService: CatalogServiceProtocol {
  ...
  private let productsData: [String: (product: Product, detailed: ProductDetailed)] = [
    "product1": (
      ...
      detailed: ProductDetailed(
        ...
        price: 149,
        rating: 3.8,
        description: "Тропический микс — это самый экзотический напиток в семействе Burn. " +
          "В основе его яркого и многогранного вкуса лежит бодрящая и заводная сладость маракуйи, " +
          "которая с лёгкостью разожжет любую вечеринку.",
        isFavorite: true,
        discount: 0.0,
        reviews: [
          Review(
            ...
            author: "Антон",
            createdAt: Date(),
            content: "Очень качественный продукт, бодрит отлично!",
            images: []
          )
        ]
      )
    ...
    "product2": (
      product: Product(
        id: "product2",
        image: URL(
          string: "https://damcdn.samokat.ru/dam-storage-ext-env-prod/2026/01/" +
            "4d4df69d-8021-4bea-a5ed-25dc9ebfeb32"
        ),
      ...
      detailed: ProductDetailed(
        ...
        price: 270,
        rating: 4.9,
        description: "Сочные бульмени с отборным фаршем из свинины и говядины, " +
          "с добавлением оливкового масла первого холодного отжима.",
        isFavorite: false,
        discount: 0.0,
        reviews: [
    ...
    "product3": (
      product: Product(
        id: "product3",
        image: URL(
          string: "https://damcdn.samokat.ru/dam-storage-ext-env-prod/2025/10/" +
            "5182d418-352d-481c-a6e5-cb479cfcfff3"
        ),
    ...
    "product4": (
      product: Product(
        ...
        image: URL(
          string: "https://damcdn.samokat.ru/dam-storage-ext-env-prod/2025/12/" +
            "8328974e-b485-4eca-8b02-64a6811c1bbe"
        ),
  ...
  func fetchCategories() async throws -> [Category] {
    ...
    return [
      Category(
        id: "category1",
        name: "Любимое из детства",
        image: URL(
          string: "https://damcdn.samokat.ru/dam-storage-ext-env-prod/2025/12/" +
            "701bc980-12cd-4ff7-9d80-0da97846384f"
        )
      ),
      Category(
        id: "category2",
      ...
      Category(
        ...
        name: "Готовая еда",
        image: URL(
          string: "https://0cdfd2bd-ded8-48d8-a8b1-11fc82cb0381.selstorage.ru/combo_set_card/" +
            "photo/be73dd41-b9b7-44c2-b629-a2fc4d72a24a.jpg"
        )
      )
    ]
  }
